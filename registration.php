...
<?php 
 ...
 $errorKeys = parse_ini_file("error.ini");
  ...
  if(isset($_POST['pinid'])){
  	...
  	$errors=validateRegistration($pinid, $email, $password);
  	
  	if(count($errors)==0){
  		$res=insertRegistrationDetails($pinid, $email, $password);
  		$_SESSION['pinid']=$pinid;
  		header("Location: showboards.php");
  	}
  }
      ...
      <form class="form-horizontal" action="" method="POST">
        ...
        <fieldset>
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="pinid"  name="pinid" class="input-xlarge">
